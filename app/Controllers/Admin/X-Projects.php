...
use App\Models\Admin\XProjectcategoriesModel;
use App\Models\Admin\XProjectsModel;

class XProjects extends BaseController
{
    public function index()
    {
        $projectDB = new XProjectsModel();
        $data = array();
        ...
        for ($index = 0; $index < count($projects); $index++) {
            $catDB = new XProjectcategoriesModel();
