...
use App\Models\Admin\XInitiavitesCategoryModel;
use App\Models\Admin\XInitiavitesModel;

class XInitiatives extends BaseController
{
    public function index()
    {
        $initiativeDB = new XInitiavitesModel();
        $data = array();
