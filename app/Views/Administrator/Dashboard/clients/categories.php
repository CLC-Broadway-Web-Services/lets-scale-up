        ...
        <div class="nk-block nk-block-lg">
            <div class="nk-block-head">
                <div class="nk-block-head-content">
                    <h4 class="nk-block-title">Client Categories</h4>
                                                        ...
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li><a href="/administrator/client/categories/<?= $category['id'] ?>"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                                    <li><a href="/administrator/client/categories/delete/<?= $category['id'] ?>"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </li>
