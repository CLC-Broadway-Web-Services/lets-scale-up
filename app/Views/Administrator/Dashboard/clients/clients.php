                            ...
                            <?php foreach ($clients as $client) : ?>
                                <tr class="nk-tb-item">
                                    <td class="nk-tb-col nk-tb-col-check">
                                        <div class="custom-control custom-control-sm custom-checkbox notext">
                                            <input type="checkbox" class="custom-control-input" id="uid<?= $client['id'] ?>">
                                            <label class="custom-control-label" for="uid<?= $client['id'] ?>"></label>
                                        </div>
                                    </td>
                                    <td class="nk-tb-col">
                                        <div class="user-card">
                                            <div class="user-info">
                                                <span class="tb-lead"><?= $client['name'] ?> <span class="dot dot-success d-md-none ml-1"></span></span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="nk-tb-col tb-col-xl">
                                        <?php if ($client['updated_at']) { ?>
                                            <span><?= date('d M Y', strtotime($client['updated_at'])) ?></span>
                                        <?php } ?>
                                    </td>
                                                ...
                                                <div class="drodown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <ul class="link-list-opt no-bdr">
                                                            <li><a href="/administrator/clients/edit/<?= $client['id'] ?>"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                            <li><a href="/administrator/clients/homestatus/<?= $client['id'] ?>"><em class="icon ni ni-eye"></em><span>Change Visible</span></a></li>
                                                            <li><a href="/administrator/clients/status/<?= $client['id'] ?>"><em class="icon ni ni-repeat"></em><span>Change Status</span></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </li>
