        ...
        <div class="nk-block nk-block-lg">
            <div class="nk-block-head">
                <div class="nk-block-head-content">
                    <h4 class="nk-block-title">Initiatives</h4>
                            ...
                            <?php foreach ($initiatives as $initiative) : ?>
                                <tr class="nk-tb-item">
                                    <td class="nk-tb-col nk-tb-col-check">
                                        <div class="custom-control custom-control-sm custom-checkbox notext">
                                            <input type="checkbox" class="custom-control-input" id="uid<?= $initiative['id'] ?>">
                                            <label class="custom-control-label" for="uid<?= $initiative['id'] ?>"></label>
                                        </div>
                                    </td>
                                    <td class="nk-tb-col">
                                        <div class="user-card">
                                            <div class="user-info">
                                                <span class="tb-lead"><?= $initiative['name'] ?> <span class="dot dot-success d-md-none ml-1"></span></span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="nk-tb-col tb-col-xl">
                                        <span><?= date('d M Y', strtotime($initiative['created_at'])) ?></span>
                                    </td>
                                    <td class="nk-tb-col tb-col-xl">
                                        <?php if ($initiative['updated_at']) { ?>
                                            <span><?= date('d M Y', strtotime($initiative['updated_at'])) ?></span>
                                        <?php } ?>
                                    </td>
                                    <td class="nk-tb-col tb-col-md" data-order="Active - Not Active">
                                        <?php if ($initiative['status'] == 1) { ?>
