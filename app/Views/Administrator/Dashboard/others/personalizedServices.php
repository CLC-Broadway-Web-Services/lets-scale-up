                    ...
                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                        <thead>
                            <tr class="nk-tb-item nk-tb-head">
                                ...
                                <th class="nk-tb-col"><span class="sub-text">Title / Subtitle</span></th>
                            ...
                            <?php foreach ($services as $service) : ?>
                                <tr class="nk-tb-item">
                                    <td class="nk-tb-col nk-tb-col-check">
                                        <div class="custom-control custom-control-sm custom-checkbox notext">
                                            <input type="checkbox" class="custom-control-input" id="uid<?= $service['id'] ?>">
                                    ...
                                    <td class="nk-tb-col tb-col-xl">
                                        <?php if ($service['updated_at']) { ?>
                                            <span><?= date('d M Y', strtotime($service['updated_at'])) ?></span>
                                        <?php } ?>
                                    </td>
                                                ...
                                                <div class="drodown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <ul class="link-list-opt no-bdr">
                                                            <li><a href="<?= route_to('personalized_service_edit', $service['id']) ?>"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                            <li><a href="<?= route_to('personalized_service_status_change', $service['id']) ?>"><em class="icon ni ni-repeat"></em><span>Change Status</span></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </li>
