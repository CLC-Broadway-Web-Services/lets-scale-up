                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-12 pt-2">
                                                <div class="form-group">
                                                    <label class="form-label">Initiative Category</label>
                                                    <div class="form-control-wrap">
                                                        <select class="form-select" name="category" data-placeholder="Select Category" required>
                                                            <option selected disabled>Select Category</option>
                                                            <?php foreach ($categories as $category) : ?>
                                                                <option <?php if ($initiativeData['category'] == $category['id']) echo 'selected' ?> value="<?= $category['id'] ?>"><?= $category['name'] ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-12 pt-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select class="form-select" name="home_status" required>
                                                            <option <?php if ($initiativeData['home_status'] == 1) echo 'selected' ?> value="1">Show on Home</option>
                                                            <option <?php if ($initiativeData['home_status'] == 0) echo 'selected' ?> value="0">Not Shown</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <textarea class="form-control" rows="8" id="description" name="description"><?= $initiativeData['description'] ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- <div class="col-12" hidden>
                                        <div class="form-group">
                                            <label class="form-label" for="page_data">Initiative Page Data</label>
                                            <div class="form-control-wrap">
                                                <textarea class="form-control" rows="8" id="page_data" name="page_data"><?php //$initiativeData['page_data'] ?></textarea>
                                            </div>
                                        </div>
                                    </div> -->
