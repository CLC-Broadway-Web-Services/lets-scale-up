 ...
 *   https://datatables.net/download/#bs5/dt-1.11.2/r-2.2.9/sb-1.2.1/sp-1.4.0/sl-1.3.3
 *
 * Included libraries:
 *   DataTables 1.11.2, Responsive 2.2.9, SearchBuilder 1.2.1, SearchPanes 1.4.0, Select 1.3.3
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.11.2/r-2.2.9/sb-1.2.1/sp-1.4.0/sl-1.3.3",
